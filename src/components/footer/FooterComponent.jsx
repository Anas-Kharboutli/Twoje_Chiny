  ...
  <> 
    ...
    <div className={styles.socialMediaLinks}>
      <a href="" target="_blank" rel="noreferrer">
        YouTube <FaYoutubeSquare className={styles.footerYoutubeIcon}/>
      </a>
      <a href="" target="_blank" rel="noreferrer">
        Facebook <FaFacebook className={styles.footerFacebookIcon}/>
      </a>
      <a href="" target="_blank" rel="noreferrer">
        Tiktok <AiFillTikTok className={styles.footerTiktokIcon}/>
      </a>
      <a href="" target="_blank" rel="noreferrer">
        Instagram <FaInstagram className={styles.footerInstagramIcon}/>
      </a>
    </div>  
  </>
);
